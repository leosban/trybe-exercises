...
assert.strictEqual(getUser(userFullName), 'Hello! My name is Ivan Ivanovich'); // completar a chamada da funcao de getuser
assert.strictEqual(getUser(userNationality), 'Ivan is Russian'); // completar a chamada da funcao ge getUser
